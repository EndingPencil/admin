...
function renderIssues(issues) {
    ...
    issues.forEach(issue => {
        ...
        // --- CORRECTED: This conditional template literal correctly handles image display ---
        issueCard.innerHTML = `
            ${issue.media_url ? `<img src="${issue.media_url}" alt="${issue.problem_type}">` : `<img src="https://via.placeholder.com/400x200.png?text=No+Image+Available" alt="No image available">`}
